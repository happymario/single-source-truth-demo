...
import { createPaginatedResponseSchema, createResponseSchema } from '../shared/common.schema';
 ...
 * 단일 사용자 응답 스키마
 */
export const SingleUserResponseSchema = createResponseSchema(UserResponseSchema);
